...
# The database file for training data. Created by data/widerface/create_data.sh
train_data = "/home/yc/workplace/deeplearning/object_detect/RefineDet/face_data/trainval_lmdb"
# The database file for testing data. Created by data/widerface/create_data.sh
test_data = "/home/yc/workplace/deeplearning/object_detect/RefineDet/face_data/test_lmdb"
...
model_name = "widerface_{}".format(job_name)
...
# Stores the test image names and sizes. Created by data/widerface/create_list.sh
